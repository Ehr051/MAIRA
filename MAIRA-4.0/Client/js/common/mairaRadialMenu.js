...
class MAIRARadialMenu {
    constructor() {
        ...
        // ⏳ Diferir inicialización hasta que DOM esté listo
        if (document.body) {
            this.init();
    ...
    init() {
        ...
        if (!document.body) {
            console.warn('⚠️ document.body no disponible - esperando DOMContentLoaded');
            return;
        }
    ...
    integrateWithMap(mapInstance) {
        console.log('🎯 Integrando menú radial con map');
