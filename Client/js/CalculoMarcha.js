...
CalculoMarchaController.prototype.calcularFactorTerreno = function(pendiente, vegetacion) {
    ...
    var factorVegetacion = vegetacion && this.factores.vegetacion[vegetacion.tipo] || 1.0;
...
window.calculoMarcha = {
    calcular: function() {
        return window.CalculoMarcha.calcular();
    },
    mostrarResultados: function(resultados) {
        return window.CalculoMarcha.mostrarResultados(resultados);
    },
    mostrarDetallesColumna: function(columnaId) {
        return window.CalculoMarcha.mostrarDetallesColumna(columnaId);
    }
};
