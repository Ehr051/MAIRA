...
function inicializarEventListeners() {
    ...
    document.getElementById('unirsePartida').addEventListener('click', mostrarFormularioUnirsePartida);
...
function mostrarFormularioUnirsePartida() {
    ocultarTodosLosFormularios();
    document.getElementById('formUnirsePartida').style.display = 'block';
}

function ocultarTodosLosFormularios() {
    ['modoLocal', 'modoOnline', 'formCrearPartida', 'formUnirsePartida', 'salaEspera'].forEach(id => {
...
async function inicializarSocket() {
    if (!socket) {
       ...
       // Manejo de conexión y desconexión
        ...
        // Inicializar otros módulos con el socket
        window.inicializarChat(socket);
        window.inicializarPartidas(socket);
...
window.mostrarFormularioUnirsePartida = mostrarFormularioUnirsePartida;
